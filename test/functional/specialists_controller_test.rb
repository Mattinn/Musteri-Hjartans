...
class SpecialistsControllerTest < ActionController::TestCase
  ...
  test "should create specialist" do
    assert_difference('Specialist.count') do
      post :create, specialist: { cms_name: @specialist.cms_name, email: @specialist.email, name: @specialist.name, phone: @specialist.phone, pnr: @specialist.pnr, title: @specialist.title }
    end
  ...
  test "should update specialist" do
    put :update, id: @specialist, specialist: { cms_name: @specialist.cms_name, email: @specialist.email, name: @specialist.name, phone: @specialist.phone, pnr: @specialist.pnr, title: @specialist.title }
    assert_redirected_to specialist_path(assigns(:specialist))
  end
